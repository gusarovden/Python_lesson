...
2. В отчете Allure вы увидите:
   1.
   - **Название теста**: 'Тест сложения 7 + 8 с задержкой 1 секунда'.
   - **Описание теста**: 'Проверяем, что калькулятор правильно складывает числа с задержкой'.
   - **Шаги теста**:
   ...
   2.
   - **Название теста**: 'Покупка товаров'.
   - **Описание теста**: 'Полный сценарий покупки: авторизация, добавление товаров в корзину, оформление заказа'.
   - **Шаги теста**:
